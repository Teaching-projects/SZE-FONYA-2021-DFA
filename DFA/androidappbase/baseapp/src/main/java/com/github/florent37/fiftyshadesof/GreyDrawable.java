...
//    android:endColor="#FFE63A54"
//    android:startColor="#FFF5BD51"
//    public final static int DEFAULT_GREY = Color.parseColor("#50E63A54");
//    public final static int DARKER_GREY = Color.parseColor("#AAF5BD51");
//
//    public final static int DEFAULT_GREY_BOLD = Color.parseColor("#50E63A54");
//    public final static int DARKER_GREY_BOLD = Color.parseColor("#AAF5BD51");
//
