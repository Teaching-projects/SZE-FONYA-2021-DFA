package com.myitsolver.baseandroidapp.recyclerviewext.stickyheader;
...
public class StickyHeadersLinearLayoutManager<T extends RecyclerView.Adapter & StickyHeaders>
    ...
    // Header positions for the currently displayed items and their observer.
...
//            Float toolbarHeight = UiData.INSTANCE.getToolbarBottomOffset().getValue();
