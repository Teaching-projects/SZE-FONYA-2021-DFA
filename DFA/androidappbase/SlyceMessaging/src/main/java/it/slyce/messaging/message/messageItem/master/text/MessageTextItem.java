...
public class MessageTextItem extends MessageItem {
    ...
    public void buildMessageItem(
        ...
        if (message != null &&  messageViewHolder != null && messageViewHolder instanceof MessageTextViewHolder) {
            ...
            messageTextViewHolder.avatar.setVisibility(isFirstConsecutiveMessageFromSource && !TextUtils.isEmpty(avatarUrl) ? View.VISIBLE : View.VISIBLE);
            messageTextViewHolder.avatarContainer.setVisibility(!SlyceMessagingFragment.ownAvatarEnable ? View.GONE : isFirstConsecutiveMessageFromSource  ? View.VISIBLE : View.INVISIBLE);
