...
public class AddNewMessageTask extends AsyncTask {
    ...
    private MessageAdditionCompletedListener listener;
    ...
    public AddNewMessageTask(
            ...
            Context context,
            CustomSettings customSettings, MessageAdditionCompletedListener listener) {
...
//        boolean isAtBottom = ((LinearLayoutManager)mRecyclerView.getLayoutManager()).findLastVisibleItemPosition() > mRecyclerAdapter.getItemCount()-3;
    ...
    public interface MessageAdditionCompletedListener{
        void onCompleted();
    }
}
